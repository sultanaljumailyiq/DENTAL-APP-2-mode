...
const medicalServices: MedicalService[] = [
  ...
  },
  {
    ...
    description: "عيادة متخصصة في جراحة الفم والفكين مع خبرة أكثر من 15 عاماً.",
  },
];
...
export default function UnifiedInteractiveMap({
  ...
  const handleBookAppointment = (serviceId: number) => {
    navigate(`/simplified-booking/${serviceId}`);
  };
  ...
  return (
    <section className="bg-white rounded-2xl shadow-lg p-1.5">
      <div className="mb-6">
      ...
      <div className="flex flex-col gap-4 mb-3">
        <div className="flex-1">{/* Empty placeholder for spacing */}</div>
        <div>
          <div className="flex gap-5">
            <div className="flex flex-col line-normal width-50% marginLeft-0">
              <select
                value={filterType}
            ...
            <div className="flex flex-col line-normal width-50% marginLeft-5">
              <input
                type="text"
